...
if __name__ == "__main__":
    ...
    for epoch in range(first_epoch,first_epoch + num_epochs):
        ...
        for train_batch_index,train_batch in enumerate(train_dataset):
            ...
            train_batch_images, train_batch_labels = to_cpu(train_batch_images, train_batch_labels)
        ...
        for test_batch_index,test_batch in enumerate(test_dataset):
            ...
            test_batch_images, test_batch_labels = to_cpu(test_batch_images, test_batch_labels)
